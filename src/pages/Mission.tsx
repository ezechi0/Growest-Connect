        ...
        <div className="relative mb-20">
          ...
          <div className="relative z-10 p-12 rounded-3xl">
            <div className="text-center mb-12 animate-bounce-in">
              ...
              <h2 className="text-4xl md:text-5xl font-bold text-white mb-6">Notre Impact Révolutionnaire</h2>
              <p className="text-white/90 text-xl max-w-3xl mx-auto">
                Ensemble, nous construisons l'avenir de l'entrepreneuriat africain avec des résultats exceptionnels
              </p>
            </div>
            
            <div className="grid md:grid-cols-4 gap-8 text-center">
              <div className="animate-scale-in" style={{animationDelay: '0.2s'}}>
                <div className="bg-white/10 backdrop-blur-md rounded-2xl p-6 hover-lift">
                  <div className="text-4xl md:text-5xl font-bold text-white mb-3 gradient-text">500+</div>
                  <div className="text-white/80 text-lg font-medium">Projets Financés</div>
                  <div className="text-white/60 text-sm mt-2">avec succès</div>
                </div>
              </div>
              <div className="animate-scale-in" style={{animationDelay: '0.4s'}}>
                <div className="bg-white/10 backdrop-blur-md rounded-2xl p-6 hover-lift">
                  <div className="text-4xl md:text-5xl font-bold text-white mb-3">€2.5M</div>
                  <div className="text-white/80 text-lg font-medium">Fonds Levés</div>
                  <div className="text-white/60 text-sm mt-2">et en croissance</div>
                </div>
              </div>
              <div className="animate-scale-in" style={{animationDelay: '0.6s'}}>
                <div className="bg-white/10 backdrop-blur-md rounded-2xl p-6 hover-lift">
                  <div className="text-4xl md:text-5xl font-bold text-white mb-3">1000+</div>
                  <div className="text-white/80 text-lg font-medium">Investisseurs Actifs</div>
                  <div className="text-white/60 text-sm mt-2">communauté solide</div>
                </div>
              </div>
              <div className="animate-scale-in" style={{animationDelay: '0.8s'}}>
                <div className="bg-white/10 backdrop-blur-md rounded-2xl p-6 hover-lift">
                  ...
                  <div className="text-white/80 text-lg font-medium">Pays Couverts</div>
                  <div className="text-white/60 text-sm mt-2">expansion continue</div>
                </div>
              </div>
            </div>
          </div>
