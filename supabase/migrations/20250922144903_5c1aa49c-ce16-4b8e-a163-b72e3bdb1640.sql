-- Création des tables pour Invest Connect

-- 1. Table des profils utilisateurs étendus
CREATE TABLE public.profiles (
  id UUID NOT NULL REFERENCES auth.users(id) ON DELETE CASCADE,
  full_name TEXT NOT NULL,
  user_type TEXT NOT NULL CHECK (user_type IN ('entrepreneur', 'business_angel', 'vc', 'institutional', 'bank')),
  company TEXT,
  bio TEXT,
  website TEXT,
  phone TEXT,
...
-- 3. Table des transactions/investissements
...
-- 5. Table des messages/conversations
...
CREATE POLICY "Les profils publics sont visibles par tous" ON public.profiles
...
CREATE POLICY "Les utilisateurs peuvent ajouter/supprimer leurs favoris" ON public.project_favorites
